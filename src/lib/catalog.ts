...
export const catalog: Record<CategoryId, Part[]> = {
  ...
  gpu: [
    ...
    withScrapedPart({
      id: "rtx-5090-fe-validation",
      category: "gpu",
      name: "RTX 5090 FE 规格验证件",
      brand: "NVIDIA / Assembly Lab",
      series: "Founders Edition / Spec-derived",
      price: 0,
      color: "#76b900",
      marketTags: ["规格验证模型", "不可购买", "非真实 CAD"],
      wattage: 575,
      lengthMm: 304,
      heightMm: 137,
      caseExpansionSlotWidth: 2,
      totalSlotWidth: 3,
      dimensions: { lengthMm: 304, widthMm: 137, thicknessMm: 61 },
      metrics: { gaming: 98, creator: 96, ai: 99, quiet: 62 },
      isCalibrationOnly: true,
    }),
    withScrapedPart({
      id: "rtx-5070-ti",
  ...
  case: [
    ...
    withScrapedPart({
      id: "cad-o11-air-mini-validation",
      category: "case",
      name: "O11 Air Mini CAD 装配验证件",
      brand: "LIAN LI / Assembly Lab",
      series: "STEP-derived Anchor Validation",
      price: 0,
      color: "#dbeafe",
      marketTags: ["CAD 验证模型", "不可购买", "本地 STEP"],
      supportedFormFactors: ["ATX", "Micro-ATX", "Mini-ITX"],
      gpuClearanceMm: 362,
      ...
      maxPsuLengthMm: 200,
      supportedPsuFormFactors: ["ATX", "SFX", "SFX-L"],
      dimensions: { depthMm: 414, widthMm: 288, heightMm: 383 },
  ...
  fans: [
    ...
    withScrapedPart({
      id: "cad-120mm-fan-validation",
      category: "fans",
      name: "120mm 风扇 2 pack CAD 验证件",
      brand: "Assembly Lab",
      series: "STEP-derived front fan validation",
      price: 0,
      color: "#67e8f9",
      marketTags: ["CAD 验证模型", "不可购买"],
      wattage: 9,
      metrics: { gaming: 70, creator: 70, ai: 70, quiet: 70 },
      isCalibrationOnly: true,
    }),
